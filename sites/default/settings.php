...
$settings['hash_salt'] = 'g_nh-OE71na6YpI81C0hmdcutbECS1p1HTey5Ooh917LfAtt8dD-4IjOBr6t-emyKDMCHdLLgQ';
...
$databases['default']['default'] = array (
  'database' => 'waterwo7_waterworks',
  'username' => 'waterwo7_wworks',
  'password' => '+f&lgGNROuw)',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '',
...
if (isset($GLOBALS['request']) and '/live/index.php' === $GLOBALS['request']->server->get('SCRIPT_NAME')) {  
